...
% Version 2.0beta juuso 101199 090200
...
while i<=length(varargin), 
  ...
  elseif isstruct(varargin{i}) & isfield(varargin{i},'type'), 
	...
	if ~isempty(varargin{i}.neigh), sTrain.neigh = varargin{i}.neigh; end
	if ~isempty(varargin{i}.mask),  sTrain.mask = varargin{i}.mask; end
      elseif strcmp(varargin{i}.type,'som_train'), 
	sTprev = varargin{i}; 
      end
